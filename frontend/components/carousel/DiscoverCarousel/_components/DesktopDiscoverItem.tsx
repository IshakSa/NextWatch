import {ChildRefActions} from "@/components/actions/AddWatchlistButton/AddWatchlistButton";
    ...
    <CarouselItem key={index} className="relative">
      <>
        ...
        <div className="h-full items-center justify-center bg-zinc-950/70 backdrop-blur-md">
          ...
          />
          <div
            className="dark absolute bottom-0 left-0 right-0 h-full bg-linear-to-t from-background to-transparent"/>
        </div>

        <div
          className="absolute inset-0 z-0 bg-zinc-950/70 backdrop-blur-md pointer-events-none h-screen"/>

        <div
          className="absolute top-1/2 -translate-y-1/2 z-50 gap-5 flex items-center w-full h-full">
          <div className="flex-1 h-full flex items-center select-none"
          ...
          <div
            className="w-full mr-10 xl:mr-15 2xl:mr-30 max-w-xs xl:max-w-sm shrink-0 flex flex-col gap-10 rounded-2xl bg-zinc-900/50 backdrop-blur-xl border border-border p-6 shadow-2xl">
