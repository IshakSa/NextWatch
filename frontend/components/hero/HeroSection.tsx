...
export default function HeroSection(
  ...
  return (
    ...
    >
      ...
      <div
        className="container absolute left-1/2 bottom-0 -translate-x-1/2 flex flex-col z-1 px-4 sm:px-6 lg:px-8 mb-10">
        <div className="flex space-x-2 mb-3 md:mb-5">
          ...
          {!isAlreadyReleased(contentItem.releaseDate) && (
            <Badge variant="secondary" className="px-3 py-2.5">Upcoming</Badge>
          )}
          ...
          <>
            ...
            <div className="flex gap-5 justify-center sm:justify-start mt-5">
              ...
              <AddWatchlistButton className="p-5 rounded-lg flex-1 w-auto sm:flex-initial"
                                  contentId={contentItem.id} contentType={contentItem.type}/>
            </div>
          </>
        ) : (
