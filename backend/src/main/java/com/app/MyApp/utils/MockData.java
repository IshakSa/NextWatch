...
public class MockData {
    ...
    public static List<ContentSummaryDto> mockDataList = List.of(
            ...
            ContentSummaryDto.builder()
                    ...
                    .posterPath("/cvsXj3I9Q2iyyIo95AecSd1tad7.jpg").backdropPath("/5i6SjyDbDWqyun8klUuCxrlFbyw.jpg")
                    .build(),

            ContentSummaryDto.builder().id(713704).title("Evil Dead Rise").genres(List.of("Horror", "Thriller"))
                    .type(ContentType.MOVIE)
                    .overview(
                    ...
                    .posterPath("/mIBCtPvKZQlxubxKMeViO2UrP3q.jpg").backdropPath("/7bWxAsNPv9CXHOhZbJVlj2KxgfP.jpg")
                    .build(),
            ...
            ContentSummaryDto.builder().id(638974).title("Murder Mystery tv")
                    ...
                    .posterPath("/s1VzVhXlqsevi8zeCMG9A16nEUf.jpg").backdropPath("/bT3IpP7OopgiVuy6HCPOWLuaFAd.jpg")
                    .build(),
            ...
            ContentSummaryDto.builder().id(315162).title("Puss in Boots: The Animated tv")
                    ...
                    .posterPath("/kuf6dutpsT0vSVehic3EZIqkOBt.jpg").backdropPath("/ouB7hwclG7QI3INoYJHaZL4vOaa.jpg")
                    .build(),
            ...
            ContentSummaryDto.builder().id(603692).title("John Wick: Chapter 4")
                    ...
                    .posterPath("/vZloFAK7NmvMGKE7VkF5UHaz0I.jpg").backdropPath("/h8gHn0OzBoaefsYseUByqsmEDMY.jpg")
                    .build(),

            ContentSummaryDto.builder().id(1048300).title("Adrenaline").genres(List.of("Action", "Thriller"))
                    .type(ContentType.MOVIE)
                    .overview(
                    ...
                    .posterPath("/qVzRt8c2v4gGBYsnaflXVVeQ9Lh.jpg").backdropPath("/nDmPjKLqLwWyd4Ssti8HCdhW5cZ.jpg")
                    .build(),
            ...
            ContentSummaryDto.builder().id(804150).title("Cocaine Bear")
                    ...
                    .posterPath("/gOnmaxHo0412UVr1QM5Nekv1xPi.jpg").backdropPath("/a2tys4sD7xzVaogPntGsT1ypVoT.jpg")
                    .build(),
            ...
            ContentSummaryDto.builder().id(1008005).title("The Communion Girl").genres(List.of("Horror"))
                    ...
                    .posterPath("/rzRb63TldOKdKydCvWJM8B6EkPM.jpg").backdropPath("/eSVu1FvGPy86TDo4hQbpuHx55DJ.jpg")
                    .build(),
            ...
            ContentSummaryDto.builder().id(946310).title("Pirates Down the Street")
                    ...
                    .posterPath("/uDsvma9dAwnDPVuCFi99YpWvBk0.jpg").backdropPath("/tFaC1Fb1sv1dALB0i9Avi76MHmn.jpg")
                    .build(),
            ...
            ContentSummaryDto.builder().id(1104040).title("Gangs of Lagos: The tv")
                    ...
                    .posterPath("/nGwFsB6EXUCr21wzPgtP5juZPSv.jpg").backdropPath("/rPSJAElGxOTko1zK6uIlYnTMFxN.jpg")
                    .build(),
            ...
            ContentSummaryDto.builder().id(758323).title("The Pope's Exorcist")
                    ...
                    .posterPath("/9JBEPLTPSm0d1mbEcLxULjJq9Eh.jpg").backdropPath("/5Y5pz0NX7SZS9036I733F7uNcwK.jpg")
                    .build(),
            ...
            ContentSummaryDto.builder().id(842945).title("Supercell")
                    ...
                    .posterPath("/gbGHezV6yrhua0KfAgwrknSOiIY.jpg").backdropPath("/m1fgGSLK0WvRpzM1AmZu38m0Tx8.jpg")
                    .build(),
            ...
            ContentSummaryDto.builder().id(849869).title("Kill Boksoon")
                    ...
                    .posterPath("/taYgn3RRpCGlTGdaGQvnSIOzXFy.jpg").backdropPath("/tYcmm8XtzRdcT6kliCbHuWwLCwB.jpg")
                    .build(),
            ...
            ContentSummaryDto.builder().id(1033219).title("Attack on Titan (Sci-Fi Live Action)")
                    ...
                    .posterPath("/qNz4l8UgTkD8rlqiKZ556pCJ9iO.jpg").backdropPath("/eNJhWy7xFzR74SYaSJHqJZuroDm.jpg")
                    .build());
    ...
    static SeasonDto season1 = SeasonDto.builder()
            ...
            .episodes(List.of(
                    ...
                    EpisodeDto.builder().runtime(56).episodeNumber(4).name("Cripples, Bastards, and Broken Things")
    ...
    static ProviderOptionsDto providersDE = ProviderOptionsDto.builder()
            .flatrate(List.of(
                    ProviderDetailsDto.builder().logoPath("/7rwgEs15tFwyR9NPQ5vpzxTj19Q.jpg").providerId(337)
                            .providerName("Disney Plus").displayPriority(2).build(),
                    ProviderDetailsDto.builder().logoPath("/2joD3S2goOB6lmepX35A8dmaqgM.jpg").providerId(421)
                            .providerName("Joyn Plus").displayPriority(49).build()))
            .buy(List.of(
                    ProviderDetailsDto.builder().logoPath("/peURlLlr8jggOwK53fJ5wdQl05y.jpg").providerId(2)
                            .providerName("Apple TV").displayPriority(4).build(),
                    ProviderDetailsDto.builder().logoPath("/5NyLm42TmCqCMOZFvH4fcoSNKEW.jpg").providerId(10)
                            .providerName("Amazon Video").displayPriority(7).build(),
                    ProviderDetailsDto.builder().logoPath("/tbEdFQDwx5LEVr8WpSeXQSIirVq.jpg").providerId(3)
    ...
    static ProviderOptionsDto providersUS = ProviderOptionsDto.builder()
            .flatrate(List.of(
                    ProviderDetailsDto.builder().logoPath("/jPXksae158ukMLFhhlNvzsvaEyt.jpg").providerId(257)
                            .providerName("fuboTV").displayPriority(5).build(),
                    ProviderDetailsDto.builder().logoPath("/zxrVdFjIjLqkfnwyghnfywTn3Lh.jpg").providerId(15)
            ...
            .rent(List.of(
                    ProviderDetailsDto.builder().logoPath("/5NyLm42TmCqCMOZFvH4fcoSNKEW.jpg").providerId(10)
                            .providerName("Amazon Video").displayPriority(13).build(),
                    ProviderDetailsDto.builder().logoPath("/tbEdFQDwx5LEVr8WpSeXQSIirVq.jpg").providerId(3)
                            .providerName("Google Play Movies").displayPriority(14).build()))
            .build();
    ...
    public static CreditsDto creditsDto = CreditsDto.builder()
            .cast(List.of(
                    ActorDto.builder().name("Edward Norton").profilePath("/8nytsqL59SFJTVYVrN72k6qkGgJ.jpg")
                            .character("The Narrator").order(0).build(),
                    ActorDto.builder().name("Brad Pitt").profilePath("/huV2cdcolEUwJy37QvH914vup7d.jpg")
                            .character("Tyler Durden").order(1).build(),
                    ActorDto.builder().name("Helena Bonham Carter").profilePath("/DDeITcCpnBd0CkAIRPhggy9bt5.jpg")
                            .character("Marla Singer").order(2).build(),
                    ActorDto.builder().name("Meat Loaf").profilePath("/7gKLR1u46OB8WJ6m06LemNBCMx6.jpg")
                            .character("Robert \"Bob\" Paulson").order(3).build(),
                    ActorDto.builder().name("Jared Leto").profilePath("/ca3x0OfIKbJppZh8S1Alx3GfUZO.jpg")
                            .character("Angel Face").order(4).build(),
                    ActorDto.builder().name("Zach Grenier").profilePath("/fSyQKZO39sUsqY283GXiScOg3Hi.jpg")
                            .character("Richard Chesler").order(5).build(),
                    ActorDto.builder().name("Holt McCallany").profilePath("/a5ax2ICLrV6l0T74OSFvzssCQyQ.jpg")
                            .character("The Mechanic").order(6).build(),
                    ActorDto.builder().name("Eion Bailey").profilePath("/hKqfGq1sPhZdQOlto0bS3igFZdP.jpg")
                            .character("Ricky").order(7).build(),
                    ActorDto.builder().name("Richmond Arquette").profilePath("/7byGiVac0GjBSVD1h6ylZlVXZK6.jpg")
                            .character("Intern").order(8).build(),
                    ActorDto.builder().name("David Andrews").profilePath("/36LEerIIN7gpG52mM3Ier7YWDbh.jpg")
                            .character("Thomas").order(9).build()))
            .directors(List.of(
                    DirectorDto.builder().name("David Fincher").profilePath("/tpEczFclQZeKAiCeKZZ0adRvtfz.jpg")
                            .build()))
            .build();
}
